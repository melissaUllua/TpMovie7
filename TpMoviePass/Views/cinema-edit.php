            ...
            <table class="table bg-light-alpha  ml-3 mr-3">
                ...
                <tbody>
                    <tr class="row ml-auto mr-5">
                        <form action="<?php echo FRONT_ROOT . "Cinema/Edit/".$cinema->getCinemaId(); ?>" method="POST">
                            ...
                            <td class="form-group">
                                ...
                                <input class="form-control mb-3" type="text"
                                    value="<?php echo $cinema->getCinemaName(); ?>" name="cinemaName"
                                    placeholder="Cinema Name">
                            </td>
                            <td class="form-group">
                                <label for=""><strong> Current Address </strong></label>
                                <input class="form-control" type="text"
                                    value="<?php echo $cinema->getCinemaAddress(); ?>" name="cinemaAddress"
                                    placeholder="Address" class="mt-3">
                        ...
                        <td class="form-group">
                            <form action="<?php echo FRONT_ROOT."Room/ShowAddView/".$cinema->getCinemaId();?>"
                                method="get">
